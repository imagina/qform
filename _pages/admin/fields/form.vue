        ...
        <div class="row" v-if="success">
          ...
          <q-form autocorrect="off" autocomplete="off" ref="formContent" class="q-col-gutter-x-md full-width row"
            ...
            <div class="col-12 col-md-8" v-if="locale.success">
              <q-input data-testid="name" outlined dense v-model="locale.formTemplate.name"
              ...
              <div class="row q-col-gutter-sm">
                ...
                <div class="col-8">
                  <q-input data-testid="prefixValue" outlined dense :label="`${$tr('iforms.cms.form.value')}`"
                    v-model="locale.formTemplate.prefix.value" />
                </div>
              </div>
              <div class="row q-col-gutter-sm">
                <div class="col-12">
                ...
                <div class="col-8">
                  <q-input data-testid="suffix" outlined dense :label="`${$tr('iforms.cms.form.value')}`"
                    v-model="locale.formTemplate.suffix.value" />
                </div>
              </div>

              <q-select data-testid="type" v-model="locale.formTemplate.width" :options="columnWidths"
                :rules="[val => !!val || $tr('isite.cms.message.fieldRequired')]" outlined dense emit-value map-options
            ...
            <div class="col-12 col-md-4" v-if="locale.success">
              <q-input data-testid="order" outlined dense v-model="locale.formTemplate.order"
                :label="`${$tr('iforms.cms.form.order')}`" />
              <q-checkbox data-testid="required" :label="$tr('isite.cms.form.required')"
            ...
            <div class="col-12 text-right">
              ...
              <q-btn v-else color="positive" :loading="loading" icon="fas fa-edit" :label="$tr('isite.cms.label.create')"
                rounded type="submit" />
            </div>
          </q-form>
        </div>
